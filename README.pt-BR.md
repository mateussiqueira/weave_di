...
> Um framework de DI + rotas pra Flutter que eu criei porque estava cansado de
> boilerplate.

MIT. Copyright (c) 2026 Mateus Siqueira. As versões 3.0.0 a 3.3.0 saíram como
proprietárias; da 3.4.0 em diante o pacote volta a ser MIT, e é assim que ele
fica.
...
└── src/
    ├── container.dart         # WeaveContainer — a interface abstrata
    ├── container_adapter.dart # WeaveContainerAdapter — a implementação
    ...
    ├── logger.dart            # WeaveLog — silencioso por padrão
...
O raciocínio atrás dessas escolhas está em [ARCHITECTURE.md](ARCHITECTURE.md),
e exemplos completos em [EXAMPLES.md](EXAMPLES.md).
